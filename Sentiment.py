...
def testDictionaryadvanced(sentencesTest, dataName, sentimentDictionary, threshold):
    ...
    diminisher = ["somewhat", "rarely", "occasionally", "almost", "fairly", "kinda", "modicum", "partially", "relatively", "some", "virtually", "barely", "few", "less", "mostly", "practically", "reasonably", "bit", "fewer", "little", "nearly", "quite", "scanty", "sparsely", "exiguous", "hardly", "marginally", "negligibly", "rather", "scarcely", "tolerably", "faintly", "insignificantly", "moderately", "partly", "slightly", "triflingly", "virtually"]
    # Creating a list of Intensifying words
    intensifier = ["absolutely", "altogether", "amazingly", "astoundlingly", "awfully", "badly", "decidedly", "bitterly", "bloody", "colossaly", "completely", "damn", "deeply", "drastically", "dreadfully", "entirely", "enormously", "especially", "exceptionally", "excessively", "extraordinarily", "extremely", "fantastically", "freaking", "frightfully", "fully", "greatly", "hella", "highly", "incredibly", "insanely", "intensly", "immensely", "largely", "literally", "lot", "lots", "massive", "mightily", "more", "outrageously", "particularly", "perfectly", "phenomenally", "pretty", "radically", "real", "really", "remarkably", "purely", "so", "soo", "sooo", "super", "supremely", "surpassingly", "strikingly", "strongly", "terribly", "terrifically", "totally", "thoroughly", "truly", "unusually", "utterly", "very", "wicked"]
